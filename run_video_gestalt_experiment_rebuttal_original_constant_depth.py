...
# Configuration
EXPERIMENT_NAME = "Video_Gestalt_Mask_Propagation_No_Depth_Ablation"
OUTPUT_DIR = "/home/esli/GenParticles_neural_stimulus/video_gestalt_masks_no_depth_ablation"
...
def run_single_experiment(scene, texture, random_seed, true_masks, points_3d, motion_3d, motion_valid_mask,
    ...
    for hb_id in range(num_hyperblobs):
        ...
        overlap = np.sum(hb_mask & first_frame_seg)
...
def run_experiment_for_scene_texture(scene, texture):
    ...
    try:
        ...
        # Extract first frame segmentation for ROI tracking
        first_frame_seg = extract_gestalt_segmentation(depth_sq, flow_sq, points_3d)
